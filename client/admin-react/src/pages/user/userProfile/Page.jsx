        ...
        <>
            <div>
                ...
                <div className="hidden xl:fixed xl:inset-y-0 xl:z-50 xl:flex xl:w-72 xl:flex-col">
                    {/* Sidebar component, swap this element with another sidebar if you like */}
                    <div className="flex grow flex-col gap-y-5 overflow-y-auto bg-gray-600 px-6 ring-1 ring-white/5">
                        <div className="flex h-16 shrink-0 items-center">
                            <img
                                alt="Your Company"
                                src={`http://localhost:3500${data.profileImg}`}
                ...
                <div className="xl:pl-72">
                    ...
                    <main>
                        ...
                        <div className="divide-y divide-white/5 bg-gray-500">
                            <div
                                ...
                                <div>
                                    ...
                                    <p className="mt-1 text-sm/6 text-gray-400">Use a permanent address where you can
                                        receive mail.</p>
                                </div>
                                        ...
                                        <div className="col-span-full">
                                            ...
                                            <div className="mt-2">
                                                <div
                                                    ...
                                                    <div
                                                        className="shrink-0 text-base text-gray-500 select-none sm:text-sm/6">example.com/
                                                    </div>
                                                    <input
                                                        id="username"
                                                        name="username"
