                ...
                {visibleRows.map((d, rowIndex) => {
                    ...
                    return (
                        ...
                        >
                            ...
                            {/*color *******************************************************************************************************/}
                            <td
                                className="py-2 px-4 max-w-[220px] truncate whitespace-nowrap overflow-hidden border-r border-b-2 border-gray-300"
                            ...
                            <td className="text-center py-2 px-4 truncate whitespace-nowrap overflow-hidden border-r border-b-2 border-gray-300 flex justify-center items-center w-full">
                                <d.operation className={"bg-gray-600 rounded-md p-1 text-gray-400 cursor-pointer"}/>
                            </td>
